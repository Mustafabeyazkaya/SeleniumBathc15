...
//        the xpath here is common to all the webElements that have age group
        List<WebElement> radioBttns = driver.findElements(By.xpath("//input[@name='ageGroup']"));
//        iterate over the list to see ur desired one
        for (WebElement radioBtn : radioBttns) {
            String age = radioBtn.getAttribute("value");
//            if the value of the WebElement is 0-5 click on it
